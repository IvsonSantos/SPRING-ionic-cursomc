...
public class SpringIonicCursomcApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringIonicCursomcApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		// cateogrias conhecem os produtos associados a ela
